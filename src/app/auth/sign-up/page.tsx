    ...
    <div className="min-h-screen flex items-center justify-center px-4 grid-bg">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted font-mono text-sm">Deploy your anti-cheat system</p>
        </div>
        ...
        >
          ...
          <div className="space-y-2">
            <label className="block text-sm font-mono text-muted">Display Name</label>
            <input
              type="text"
              value={name}
          ...
          <p className="text-center text-sm font-mono text-muted">
            Already protected?{" "}
            <a href="/auth/sign-in" className="text-neon-blue hover:underline">
              Sign in
            </a>
          </p>
        </form>
